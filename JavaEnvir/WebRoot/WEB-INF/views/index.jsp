...
<body>
    ...
    <div id="index_layout">
        ...
        <div data-options="region:'center'" style="overflow: hidden;">
            <div id="index_tabs" style="overflow: hidden;">
                <div title="首页" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
                    <script src='${staticPath }/static/test.js'></script>
                    <style>
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by <a href="#" target="_blank">IT管理本部</a></div>
    </div>
    <div id="tabsMenu">
