...
public class GenerateCode {
    ...
    /* 生成代码包名 */
    private static final String PACKAGE_NAME = "com.gwm";
...
//        cg.setTableNames(new String[]{"user"});
         ...
         */
        cg.setTableNames(new String[]{"wasalaryinfo"});
        ...
        /* 生成文件保存位置 */
        cg.setSaveDir("D:/generator/code");
