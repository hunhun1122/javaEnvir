...
public class WadepartinfoController extends BaseController {

	@Autowired
	private IWadepartinfoService wadepartinfoService;
	/***
	 * 列表界面
	 * 
	 * @return
	...
	public PageInfo dataGrid(Integer page, Integer rows) {
		...
		wadepartinfoService.selectDataGrid(pageInfo);
		return pageInfo;
	}
...
//		wastaffinfo.setCreatename(getStaffName());
    ...
    public String editPage(Model model, Long id) {
    	Wadepartinfo wadepartinfo= wadepartinfoService.selectById(id);
        model.addAttribute("wastaffinfo", wadepartinfo);
...
//		equipment.setCreatename(getStaffName());
     ...
     */
        ...
        @ResponseBody
        public Object delete(Wadepartinfo wadepartinfo) {
